...
import { LayoutDashboard, Ticket, Users, FileText, Settings, LogOut } from 'lucide-react';
    ...
    return (
        <aside className="w-64 bg-cge-sidebar text-white h-screen fixed left-0 top-0 flex flex-col shadow-xl z-50">
            <div className="p-6 border-b border-white border-opacity-10">
                ...
                <p className="text-xs text-gray-300 mt-1">Panel de Agente</p>
            </div>
            ...
            <div className="p-4 border-t border-white border-opacity-10">
                ...
                <button className="flex items-center gap-3 px-4 py-3 w-full text-left text-red-300 hover:bg-white hover:bg-opacity-5 hover:text-red-200 rounded-lg transition-colors mt-2">
                    <LogOut size={20} />
